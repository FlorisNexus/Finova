...
/// Format: 13 digits.
/// </summary>
public partial class SloveniaNationalIdValidator : NationalIdValidatorBase
{
    ...
    protected override bool ValidateFormat(string sanitized)
    {
        ...
        int fullYear = yearPart >= 850 ? 1000 + yearPart : 2000 + yearPart;
    ...
    /// <summary>
    /// Static validation method for Slovenian EMŠO.
    /// </summary>
        public static ValidationResult ValidateStatic(string? nationalId) => new SloveniaNationalIdValidator().Validate(nationalId);
}