...
/// Format: 13 digits.
/// </summary>
public partial class MontenegroNationalIdValidator : NationalIdValidatorBase
{
    ...
    /// <summary>
    /// Static validation method for Montenegrin JMBG.
    /// </summary>
        public static ValidationResult ValidateStatic(string? nationalId) => new MontenegroNationalIdValidator().Validate(nationalId);
}