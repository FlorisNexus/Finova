...
/// <summary>
/// Validator for Serbian National Identification Number (JMBG).
/// Format: 13 digits.
/// </summary>
public partial class SerbiaNationalIdValidator : NationalIdValidatorBase
{
    ...
    /// <summary>
    /// Static validation method for Serbian JMBG.
    /// </summary>
        public static ValidationResult ValidateStatic(string? nationalId) => new SerbiaNationalIdValidator().Validate(nationalId);
}