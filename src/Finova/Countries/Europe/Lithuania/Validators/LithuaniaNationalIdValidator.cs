...
/// <summary>
/// Validator for Lithuanian Personal Code (Asmens kodas).
/// Format: 11 digits.
/// </summary>
public partial class LithuaniaNationalIdValidator : NationalIdValidatorBase
{
    ...
    /// <summary>
    /// Static validation method for Lithuanian National ID.
    /// </summary>
        public static ValidationResult ValidateStatic(string? nationalId) => new LithuaniaNationalIdValidator().Validate(nationalId);
}